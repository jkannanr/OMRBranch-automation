...
Feature: Verifying Adactin Hotel Book Hotel details
  ...
  Scenario Outline: Verifying Adactin Hotel after entering Book hotel details
  ...
  Scenario Outline: Verifying Adactin Hotel without entering Book hotel details
    Given User is on Adactin Page
    When User should perform Login "<username>", "<password>"
    Then User should verify after Login success message "Hello jkannanr!"
    When User should enter Search Hotel fields "<location>", "<hotelName>","<roomType>","<numberofRooms>","<checkInDate>","<checkOutDate>","<adultsperRoom>" and "<childrensPerRoom>"
    ...
    When User should click continue after selecting hotel name
    Then User should verify after Select Hotel success message "Book A Hotel"
    And User should enter book now without entering book hotel fields and Credit card fields
    Then User should verify error messages after clicking book now button "Please Enter your First Name", "Please Enter you Last Name", "Please Enter your Address","Please Enter your 16 Digit Credit Card Number", "Please Select your Credit Card Type", "Please Select your Credit Card Expiry Month", "Please Enter your Credit Card CVV Number"
